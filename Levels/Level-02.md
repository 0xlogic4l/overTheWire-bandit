...
```text
# The current directory contains on file named "--spaces in this filename--"
```
...
* After logging in, the password for the next level can be found in the `--spaces in this filename--` file located in the home directory.
...
This challenge about files named with white space and special charachter like `--spaces in this filename--`
...
* Practiced reading the contents of a files named with special charachter and white space using the `cat` command.
